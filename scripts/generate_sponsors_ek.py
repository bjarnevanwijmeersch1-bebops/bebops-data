#!/usr/bin/env python3
"""
Generate EK sponsor HTML pages from images in the sponsors-ek folder.
...
SPONSORS_IMAGES_DIR = IMAGES_DIR / "sponsors-ek"
OUTPUT_DIR = PROJECT_ROOT / "frames" / "sponsors-ek"
...
def generate_sponsor_html(sponsor_name: str, sponsor_image_base64: str, logo_base64: str) -> str:
    """Generate HTML for an EK sponsor page."""
...
def main():
    """Main function to generate all EK sponsor pages."""
    ...
    print(f"Found {len(sponsor_images)} EK sponsor images")
    ...
    print(f"\nDone! Generated {len(generated_files)} EK sponsor pages")
